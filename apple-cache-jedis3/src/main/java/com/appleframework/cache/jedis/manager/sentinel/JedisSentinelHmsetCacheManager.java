...
public class JedisSentinelHmsetCacheManager implements CacheManager {

	private static Logger logger = LoggerFactory.getLogger(JedisSentinelHmsetCacheManager.class);
