...
public class SpringCache implements Cache {
	...
	public SpringCache(CacheManager cacheManager, String name) {
		this.name = name;
		this.cacheOperation = new SpringCacheOperation(cacheManager, name);
	}
	...
	public SpringCache(CacheManager cacheManager, String name, int expire, boolean isOpen) {
		this.name = name;
		this.isOpen = isOpen;
		this.cacheOperation = new SpringCacheOperation(cacheManager, name, expire);
	}
