...
public class JedisClusterHsetCacheManager implements CacheManager {

	private static Logger logger = LoggerFactory.getLogger(JedisClusterHsetCacheManager.class);
