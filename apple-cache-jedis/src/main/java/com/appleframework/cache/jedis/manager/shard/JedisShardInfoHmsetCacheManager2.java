...
public class JedisShardInfoHmsetCacheManager2 implements CacheManager {

	private static Logger logger = LoggerFactory.getLogger(JedisShardInfoHmsetCacheManager2.class);
