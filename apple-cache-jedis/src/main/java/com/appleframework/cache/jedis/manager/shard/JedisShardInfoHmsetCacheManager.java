...
public class JedisShardInfoHmsetCacheManager implements CacheManager {

	private static Logger logger = LoggerFactory.getLogger(JedisShardInfoHmsetCacheManager.class);
