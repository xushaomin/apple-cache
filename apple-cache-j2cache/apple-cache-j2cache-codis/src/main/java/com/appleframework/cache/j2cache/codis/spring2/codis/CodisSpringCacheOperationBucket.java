...
public class CodisSpringCacheOperationBucket implements CacheOperation {
	...
	public CodisSpringCacheOperationBucket(CodisResourcePool codisResourcePool, String name, int expireTime) {
		this.name = name;
