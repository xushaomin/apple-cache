...
public class CodisSpringCacheOperationHset implements CacheOperation {
	...
	public CodisSpringCacheOperationHset(CodisResourcePool codisResourcePool, String name, int expireTime) {
		this.name = name;
