...
public class EhcacheSpringCacheOperation implements CacheOperation {

	private static Logger logger = Logger.getLogger(EhcacheSpringCacheOperation.class);
	...
	public EhcacheSpringCacheOperation(CacheManager ehcacheManager, String name) {
		this.name = name;
		this.init(ehcacheManager);
	}

	public EhcacheSpringCacheOperation(CacheManager ehcacheManager, String name, int expire) {
		this.name = name;
		this.expire = expire;
		this.init(ehcacheManager);
	}
