...
public class SpringCache implements Cache {
	...
	public SpringCache(CacheManager cacheManager, PoolFactory poolFactory, String name, int expire, boolean isOpen) {
		this.name = name;
		this.isOpen = isOpen;
		this.cacheOperation = new SpringCacheOperation(cacheManager, poolFactory, name, expire, isOpen);
	}
	...
	public SpringCache(CacheManager cacheManager, PoolFactory poolFactory, String name, int expire, boolean isOpen,
		...
		this.name = name;
		this.isOpen = isOpen;
		this.cacheOperation = new SpringCacheOperation(cacheManager, poolFactory, name, expire, isOpen, commandReplicator);
	}
